    ...
    <div id="container-main">
        ...
        <div id="box-top">
          ...
          <div id="box-top-right">
            <p id="name-header">EmeritusUmar</p>
      ...
      <div id="name-id-box">
        <p id="name-user">EmeritusUmar</p>
        <p id="id-user">@Oladele7532</p>
      </div>
      ...
      <Tweet
        ...
        likeNumber="60"
      />
      <Tweet tweet="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua." likeNumber="60" />
      <Tweet
        tweet="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
        likeNumber="60"
      />
